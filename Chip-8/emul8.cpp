...
int main(int argc, char *argv[])
{
	...
	if(!gamer.init(argv[1])){
		cout<<"ERROR FAILED TO LOAD THE APPLICATION"<<endl;
		return 1;
	}
...
if(key == '1')		gamer.key[0x1] = 1;
else if(key == '2')	gamer.key[0x2] = 1;
else if(key == '3')	gamer.key[0x3] = 1;
else if(key == '4')	gamer.key[0xC] = 1;

else if(key == 'q')	gamer.key[0x4] = 1;
else if(key == 'w')	gamer.key[0x5] = 1;
else if(key == 'e')	gamer.key[0x6] = 1;
else if(key == 'r')	gamer.key[0xD] = 1;

else if(key == 'a')	gamer.key[0x7] = 1;
else if(key == 's')	gamer.key[0x8] = 1;
else if(key == 'd')	gamer.key[0x9] = 1;
else if(key == 'f')	gamer.key[0xE] = 1;

else if(key == 'z')	gamer.key[0xA] = 1;
else if(key == 'x')	gamer.key[0x0] = 1;
else if(key == 'c')	gamer.key[0xB] = 1;
else if(key == 'v')	gamer.key[0xF] = 1;
...
void your_key_release_handler(unsigned char key, int x, int y)
{
	if(key == '1')		gamer.key[0x1] = 0;
	else if(key == '2')	gamer.key[0x2] = 0;
	else if(key == '3')	gamer.key[0x3] = 0;
	else if(key == '4')	gamer.key[0xC] = 0;

	else if(key == 'q')	gamer.key[0x4] = 0;
	else if(key == 'w')	gamer.key[0x5] = 0;
	else if(key == 'e')	gamer.key[0x6] = 0;
	else if(key == 'r')	gamer.key[0xD] = 0;

	else if(key == 'a')	gamer.key[0x7] = 0;
	else if(key == 's')	gamer.key[0x8] = 0;
	else if(key == 'd')	gamer.key[0x9] = 0;
	else if(key == 'f')	gamer.key[0xE] = 0;

	else if(key == 'z')	gamer.key[0xA] = 0;
	else if(key == 'x')	gamer.key[0x0] = 0;
	else if(key == 'c')	gamer.key[0xB] = 0;
	else if(key == 'v')	gamer.key[0xF] = 0;
}
